...
import 'package:test_app/core/widgets/common_widget.dart';
import 'package:test_app/features/mahasiswa/data/models/mahasiswa_model.dart';
import 'package:test_app/features/mahasiswa/presentation/providers/mahasiswa_provider.dart';
...
class SavedUserSection extends ConsumerWidget {
  ...
  const SavedUserSection({required this.savedUsers, required this.ref});
...
class MahasiswaListWithSave extends ConsumerWidget {
  ...
  const MahasiswaListWithSave({required this.mahasiswaList, required this.onRefresh});
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              leading: CircleAvatar(child: Text(mahasiswa.nim.substring(0, 1))),
              title: Text(mahasiswa.nama),
              subtitle: Text(
                '${mahasiswa.nim} • ${mahasiswa.email}\n${mahasiswa.jurusan}',
                style: const TextStyle(fontSize: 11),
                maxLines: 2,

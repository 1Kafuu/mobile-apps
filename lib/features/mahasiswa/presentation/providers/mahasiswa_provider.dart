...
import 'package:test_app/core/services/local_storage_service.dart';
...
// LocalStorageService Provider (unique name for mahasiswa)
...
final mahasiswaNotifierProvider =
    StateNotifierProvider.autoDispose<MahasiswaNotifier, AsyncValue<List<MahasiswaModel>>>(
  (ref) {
...
// Provider semua data user yang disimpan (unique name for mahasiswa)
...
// Provider untuk membaca saved user dari local storage (unique name for mahasiswa)
...
// Provider tambahan untuk Profile
final profileProvider = FutureProvider.autoDispose<MahasiswaModel>((ref) async {

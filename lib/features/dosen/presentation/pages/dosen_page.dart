...
import 'package:test_app/features/dosen/data/models/dosen_model.dart';
import 'package:test_app/features/dosen/presentation/providers/dosen_provider.dart';
...
class DosenListWithSave extends ConsumerWidget {
  ...
  const DosenListWithSave({required this.dosenList, required this.onRefresh});
